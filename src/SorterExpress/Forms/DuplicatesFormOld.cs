...
{
    public partial class DuplicatesFormOld : Form
    {
        public static DuplicatesFormOld form;
        ...
        public DuplicatesFormOld(DirectoryInfo dirInfo)
        {
            InitializeComponent();
            form = this;
        ...
        private void Worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            prints.RemoveAll(t => !scope.Contains(t.filepath.Replace(directory, "")));
                ...
                Parallel.ForEach(
                    ...
                    (filename, state) =>
                    {
                        ...
                        else
                        {
                            ...
                            //try
                            //{
                                if (!prints.Exists(t => t.filepath.Replace(directory, "") == filename))
                                {
                                ...
                                else
                                {
                                    ...
                                    print = prints.Find(t => t.filepath.Replace(directory, "") == filename);
                                }
                            /*}
                                        ...
                                        if (print != prints[i])
                                        {
                                            ...
                                            if (FilePrint.GetSimilarityPercentage(print, prints[i]) >= similarityNumeric.Value)
                                            {
                                                try
                                                {
                                                    ...
                                                    if (!duplicates.Any(t => t.File2Path == print.filepath && t.File1Path == prints[i].filepath))
                                                    {
                                                        Invoke((MethodInvoker)delegate()
                                                        {
